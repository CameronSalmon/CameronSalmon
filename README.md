...
I'm **Cameron Salmon**, a U.S. Marine Corps telecommunications veteran (MOS 2847) moving into cybersecurity.

## About Me

Four years in Marine Corps communications maintenance — leading technicians, diagnosing failures, and keeping mission-critical systems accountable and documented. I'm applying that same structured approach to security work, and documenting it publicly as I go.

Currently finishing MyComputerCareer's Cyber Warrior program, with Security+ scheduled and CySA+ to follow.

**Looking for:** entry-level Cybersecurity Analyst, Security Operations, or Information Security roles.
...
- **Security:** Incident response, threat identification and classification, access control, risk assessment, malware classes, social engineering, domain spoofing and typo-squatting
- **Networking:** TCP/IP, DNS, DHCP, LAN/WAN, subnetting, switching, network troubleshooting, Cisco Packet Tracer
- **Systems:** Windows 10/11, Active Directory fundamentals, Microsoft 365, Windows command line, `sfc` and `DISM` repair, hardware and software diagnostics
- **Practice:** Technical documentation, incident write-ups, asset management, Git and GitHub
